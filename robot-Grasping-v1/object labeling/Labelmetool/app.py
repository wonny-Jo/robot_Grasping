...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def __init__(self, filename=None, output=None):
        ...
        self.dock = QDockWidget('Polygon Label', self)
        ...
        # Actions
        # TODO
        QShortcut(QKeySequence("Z"), self, self.prev_idx)
        QShortcut(QKeySequence("X"), self, self.next_idx)
        QShortcut(QKeySequence("O"), self, self.img_open)
        ...
        createMode = action('Create\nPolygo&ns', self.setCreateMode,
                'V', 'new', 'Start drawing polygons', enabled=False)
        editMode = action('&Edit\nPolygons', self.setEditMode,
                'Esc', 'edit', 'Move and edit polygons', enabled=False)
        ...
        self.item_list = ['Eraser_big','Usb_Big','Stapler_pink','gotica']


        # TODO: Directory Path,
        self.image_path = "C:/Users/Park/Desktop/mask_rcnn/Labelmetool/수정할 오브젝트들/25/"
        self.json_path = "C:/Users/Park/Desktop/mask_rcnn/Labelmetool/json/"
        self.item_num = 0

        self.max_len = len(os.listdir(self.image_path))
        self.obj_idx = starting_obj_num
        #self.obj_idx = 0
        self.img_idx = 0

        # TODO
        self.starting_pt = starting_point
        #self.starting_pt = 0
    ...
    def img_open(self):
        # if self.starting_pt + self.img_idx <= self.max_len:
        #     file = "{}.png".format(self.starting_pt + self.img_idx)
    ...
    def next_idx(self):
        ...
        print("- Target Object : %s" % self.item_list[self.obj_idx])
    ...
    def newShape(self):
        ...
        """
        text = self.item_list[self.obj_idx]
    ...
    def loadFile(self, filename=None):
        ...
        if QFile.exists(filename):
            ...
            print("Target Object : {}".format(self.item_list[starting_obj_num]))
            #print("Target Object : {}".format(self.item_list[0]))
            return True
        return False
    ...
    def saveFile(self, _value=False):
        ...
        if self.hasLabels():
            filename = self.json_path + "%s.json"% (self.starting_pt + self.img_idx - 1)
            self._saveFile(filename)
            print(">> {}.json Saved.   Segmented Item num. : {}".format(self.starting_pt + self.img_idx - 1, self.item_num))
