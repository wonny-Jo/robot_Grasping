...
flags = tf.app.flags
flags.DEFINE_string('data_dir_path', 'C:/Users/Park/Desktop/mask_rcnn/OBJDetection_DataCollector_Mask/result', 'Path to root directory to dataset.')
flags.DEFINE_string('images_dir', 'img', 'Name of the directory contatining images')
flags.DEFINE_string('annotations_dir', '', 'Name of the directory contatining annotations(masks/xmls)')
flags.DEFINE_string('masks_dir', 'seg', 'Name of the directory contatining masks')
flags.DEFINE_string('xmls_dir', 'xml', 'Name of the directory contatining xmls')
flags.DEFINE_string('label_map_path', 'C:/Users/Park/Desktop/mask_rcnn/OBJDetection_DataCollector_Mask/result/labelmap.pbtxt', 'Path to label map proto')
...
def main(_):
  ...
  annotations_dir_path = data_dir_path
  tfrecord_dir_path = FLAGS.data_dir_path
  label_map_dict = label_map_util.get_label_map_dict(FLAGS.label_map_path)
  for key in list(label_map_dict.keys()):
